...
?>
 ...
 <p>
  ...
  <label for="<?php echo $this->get_field_id('album_select'); ?>">
	 <?php _e('Select Sermon:','crunchpress');?> 
  ...
  <label for="<?php echo $this->get_field_id('number_of_tracks'); ?>">
	 <?php _e(' Number of Tracks','crunchpress');?>
		...
		<script>
			...
			<div class="play-box">
				...
				<div class="text">
					...
					<strong class="name"><span><?php _e('By','crunchpress');?></span> <?php the_author();?></strong>					
					<div class="btn-row">
						<?php $cp_album_class = new cp_album_class;	echo $cp_album_class->getPostLikeLink($album_select);?>
						<div class="btns-row">
							<a href="<?php echo get_permalink($album_select);?>" class="btn-download"><?php _e('Download','crunchpress');?><i class="icon-plus-sign"></i></a>						
							<a id="playlist-active" class="btn-playlist"><?php _e('Playlist','crunchpress');?><i class="icon-plus-sign"></i></a>
						</div>
					</div>
				</div>
