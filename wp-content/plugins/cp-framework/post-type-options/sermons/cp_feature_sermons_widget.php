...
?>
 ...
 <p>
  ...
  <label for="<?php echo $this->get_field_id('album_select_feature'); ?>">
	  <?php _e('Select Feature Sermon:','crunchpress');?>
  ...
  <label for="<?php echo $this->get_field_id('number_of_tracks'); ?>">
	  <?php _e('Number of Sermons','crunchpress');?>
			...
			if($album_select_feature <> '786512'){ 
				...
				<div class="video-box"><?php echo get_the_post_thumbnail($album_select_feature, array(1170,350));?>
					<ul>
						...
						<li class="headphone-icon"><span class="font-aw"><i class="icon-music"></i></span><?php echo $track_name_array->length;?> <?php _e('Songs','crunchpress');?></li>
					</ul>
				</div>
			  <?php
			//Arguments for loop
					...
					<li class="even">
						...
						<div class="text-box-1">
						  <ul>
							...
							<li class="headphone-icon"><span class="font-aw"><i class="icon-calendar-empty"></i></span><strong class="time"><?php echo __('Release Date','crunchpress');?>   -  <?php echo get_the_date(get_option('date_format'));?></strong></li>
							<li class="headphone-icon"><strong class="time"><span class="font-aw"><i class="icon-music"></i></span><?php echo $track_name_array->length;?> <?php _e('Songs','crunchpress');?></strong>
							</li>
						  </ul>
						</div>
					</li>
