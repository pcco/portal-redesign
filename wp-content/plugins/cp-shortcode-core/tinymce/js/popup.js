...
jQuery(document).ready(function($) {
    		...
    		$('.child-clone-rows').appendo({
                ...
                onAdd: function(row) {
                    ...
                    if(type == 'image') {
                        ...
                        $(row).find('#_crunchp_cshortcode').text('[slide type="{{slider_type}}" link="{{image_url}}" linktarget="{{image_target}}" lightbox="{{image_lightbox}}"]{{image_content}}[/slide]');   
                    }
    ...
    $('#crunchp_slider_type').live('change', function(e) {
        ...
        if(type == 'image') {
            ...
            $('#_crunchp_cshortcode').text('[slide type="{{slider_type}}" link="{{image_url}}" linktarget="{{image_target}}" lightbox="{{image_lightbox}}"]{{image_content}}[/slide]');   
        }
    });
