				...
				<div class="row-fluid">
					<ul class="panel-body recipe_class span6">
						<li class="panel-input full-width">
							...
							<p><?php _e('You can turn On/Off Top Bar. Social Icons, Sign in Sign up search everything will be disappear onces you turn it off.','crunchpress');?></p>
						</li>
					</ul>
					<ul class="panel-body recipe_class span6">
						<li class="panel-input full-width">
				...
				<div class="row-fluid">
					<ul class="panel-body recipe_class span4">
						<li class="panel-input full-width">
							<span class="panel-title">
								<h3>
									<?php _e('TOP COUNTER', 'crunchpress'); ?>
								</h3>
							</span>
							<label for="topcounter_circle">
								<div class="checkbox-switch <?php echo ($topcounter_circle=='enable' || ($topcounter_circle=='' && empty($default)))? 'checkbox-switch-on': 'checkbox-switch-off'; ?>"></div>
							</label>
							...
							<?php echo ($topcounter_circle=='enable' || ($topcounter_circle=='' && empty($default)))? 'checked': ''; ?>>
							<!--<p><?php _e('You can turn On/Off Top Bar. Note: Turning it off Search and Top Social Networking Icons will be activated.','crunchpress');?></p>-->
							<p><?php _e('You can turn On/Off top counter from here.','crunchpress');?></p>
						</li>
					</ul>
					<ul class="panel-body recipe_class span4">
						 <li class="panel-input full-width">
