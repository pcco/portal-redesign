...
jQuery(document).ready(function () {
    ...
    var DIV_SIZE = [
        ...
        ['1/2', 'element1-2', 1 / 2, ['Featured-News','News','Services','Timeline','Sidebar','Contact-Form', 'Column', 'Gallery',  'Single-Album','Content','Slider', 'Accordion', 'Tab', 'Message-Box', 'Toggle-Box','Venue']],
        ['2/3', 'element2-3', 2 / 3, ['Next-Events','Sidebar','Event-Calendar','Events','Music-Gallery','Services','Column', 'Gallery', 'Contact-Form', 'Content', 'Slider', 'Accordion', 'Tab', 'Message-Box', 'Toggle-Box','Venue']],
        ...
        ['1/1', 'element1-1', 1, ['Featured-News','Crowd-Funding','Timeline','Feature-Projects','Woo-Products','Next-Events','Sidebar','Artists','Services', 'Column', 'Gallery', 'Content', 'Blog','Events','Music-Gallery', 'News', 'Albums', 'Slider', 'Accordion', 'Tab', 'Divider', 'Message-Box', 'Toggle-Box', 'Contact-Form']],
    ];
