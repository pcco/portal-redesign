	...
	<div class="content-area-main row-fluid"> 
      ...
      <div class="sidebar-wraper span2">
       ...
       <ul id="wp_t_o_right_menu">
					<li class="social_networking" id="active_tab"><?php _e('Social Networking', 'crunchpress'); ?></li>
					<li class="social_sharing"><?php _e('Social Sharing', 'crunchpress'); ?></li>
				</ul>
        </div>
      </div>
		  <!--sidebar end --> 
							...
							<li id="social_networking" class="social_network_class active_tab">
								<div class="row-fluid">
									<ul class="panel-body recipe_class span4">											
										<li class="panel-input full-width">
											<span class="panel-title">
												<h3 for="facebook_network" > <?php _e('Facebook', 'crunchpress'); ?> </h3>
											</span>	
											...
											<p><?php _e('Please paste your Profile URl','crunchpress');?></p>
										</li>
									</ul>
									<ul class="panel-body recipe_class span4">
										<li class="panel-input full-width">
											<span class="panel-title">
												<h3 for="twitter_network" > <?php _e('Twitter', 'crunchpress'); ?> </h3>
											</span>
									...
									<ul class="panel-body recipe_class span4">	
										<li class="panel-input full-width">
											<span class="panel-title">
												<h3 for="delicious_network" > <?php _e('Delicious', 'crunchpress'); ?> </h3>
											</span>
								...
								<div class="row-fluid">
									<ul class="panel-body recipe_class span4">												
										<li class="panel-input full-width ">
											<span class="panel-title">
												<h3 for="google_plus_network" > <?php _e('Google Plus', 'crunchpress'); ?> </h3>
											</span>	
									...
									<!--<ul class="panel-body recipe_class">
										<li class="panel-title">
											<label for="su_network" > <?php _e('Stumble Upon', 'crunchpress'); ?> </h3>
										</li>				
										<li class="panel-input full-width">
									...
									<ul class="panel-body recipe_class span4">
										...
										<li class="panel-input full-width ">
											<span class="panel-title">
											<h3 for="linked_in_network" > <?php _e('Linked In', 'crunchpress'); ?> </h3>
										</span>	
									...
									<!--<ul class="panel-body recipe_class">
										<li class="panel-title">
											<label for="digg_network" > <?php _e('Digg', 'crunchpress'); ?> </h3>
										</li>				
										<li class="panel-input full-width">
									...
									<ul class="panel-body recipe_class">
										<li class="panel-title">
											<label for="myspace_network" > <?php _e('Myspace', 'crunchpress'); ?> </h3>
										</li>				
										<li class="panel-input full-width">
									...
									<ul class="panel-body recipe_class">
										<li class="panel-title">
											<label for="reddit_network" > <?php _e('Reddit', 'crunchpress'); ?> </h3>
										</li>				
										<li class="panel-input full-width">
									...
									<ul class="panel-body recipe_class span4">
										...
										<li class="panel-input full-width">
										<span class="panel-title">
											<h3 for="youtube_network" > <?php _e('Youtube', 'crunchpress'); ?> </h3>
										</span>
								...
								<div class="row-fluid">
									<ul class="panel-body recipe_class span4">
										...
										<li class="panel-input full-width ">
										<span class="panel-title">
											<h3 for="flickr_network" > <?php _e('Flickr', 'crunchpress'); ?> </h3>
										</span>	
									...
									<ul class="panel-body recipe_class">
										<li class="panel-title">
											<label for="picasa_network" > <?php _e('Picasa', 'crunchpress'); ?> </h3>
										</li>				
										<li class="panel-input full-width">
									...
									<ul class="panel-body recipe_class span4">
										...
										<li class="panel-input full-width ">
											<span class="panel-title">
											<h3 for="vimeo_network" > <?php _e('Vimeo', 'crunchpress'); ?> </h3>
										</span>		
									...
									<ul class="panel-body recipe_class span4">
										...
										<li class="panel-input full-width ">
										<span class="panel-title">
											<h3 for="pinterest_network" > <?php _e('Pinterest', 'crunchpress'); ?> </h3>
										</span>	
								...
								<div class="row-fluid">
									<ul class="panel-body recipe_class span4">
										...
										<li class="panel-input full-width ">
										<span class="panel-title">
											<h3> <?php _e('Instagram', 'crunchpress'); ?> </h3>
										</span>	
									...
									<ul class="panel-body recipe_class span4">
										<li class="panel-input full-width ">
											<span class="panel-title">
											<h3> <?php _e('Github', 'crunchpress'); ?> </h3>
										</span>		
									...
									<ul class="panel-body recipe_class span4">
										<li class="panel-input full-width ">
										<span class="panel-title">
											<h3> <?php _e('Skype', 'crunchpress'); ?> </h3>
										</span>	
							...
							<li id="social_sharing" class="social_sharing_class">
								<div class="row-fluid">
									<ul class="panel-body recipe_class span4">
										<li class="panel-input full-width ">
											<span class="panel-title">
												<h3 for="facebook_sharing" > <?php _e('FACEBOOK SHARING', 'crunchpress'); ?> </h3>
											</span>
											...
											<p> <?php _e('Please turn On/Off sharing on post detail page.','crunchpress');?></p>
										</li>
									</ul>
									<ul class="panel-body recipe_class span4">
										<li class="panel-input full-width ">
											<span class="panel-title">
												<h3 for="twitter_sharing" > <?php _e('TWITTER SHARING', 'crunchpress'); ?> </h3>
											</span>	
									...
									<ul class="panel-body recipe_class span4">
										<li class="panel-input full-width ">
											<span class="panel-title">
												<h3 for="stumble_sharing" > <?php _e('STUMBLEUPON SHARING', 'crunchpress'); ?> </h3>
											</span>
								...
								<div class="row-fluid">							
									<ul class="panel-body recipe_class span4">									
										<li class="panel-input full-width ">
											<span class="panel-title">
												<h3 for="delicious_sharing" > <?php _e('DELICIOUS SHARING', 'crunchpress'); ?> </h3>
											</span>	
									...
									<ul class="panel-body recipe_class span4">
										...
										<li class="panel-input full-width ">
										<span class="panel-title">
											<h3 for="googleplus_sharing" > <?php _e('GOOGLE PLUS SHARING', 'crunchpress'); ?> </h3>
										</span>
									...
									<ul class="panel-body recipe_class span4">
										<li class="panel-input full-width ">
											<span class="panel-title">
												<h3 for="digg_sharing" > <?php _e('DIGG SHARING', 'crunchpress'); ?> </h3>
											</span>
								...
								<div class="row-fluid">										
									<ul class="panel-body recipe_class span4">									
										<li class="panel-input full-width ">
											<span class="panel-title">
												<h3 for="myspace_sharing" > <?php _e('MYSPACE SHARING', 'crunchpress'); ?> </h3>
											</span>	
									...
									<ul class="panel-body recipe_class span4">
										<li class="panel-input full-width ">
											<span class="panel-title">
												<h3 for="reddit_sharing" > <?php _e('REDDIT SHARING', 'crunchpress'); ?> </h3>
											</span>	
