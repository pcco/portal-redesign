		...
		if (!empty($title))
			...
			<?php
				...
				$popularpost = new WP_Query( array( 'ignore_sticky_posts' => true,'posts_per_page' => $nop, 'post_type'=> 'post', 'meta_key' => 'popular_post_views_count', 'orderby' => 'popular_post_views_count meta_value_num', 'order' => 'DESC'  ) );
					...
					?>
					<!-- Church Widget Popular Post Code -->
					<li> 
						<a class="play" href="<?php echo get_permalink();?>"><i class="fa fa-edit"></i></a>
						<div class="text-box"> 
							<strong class="title"><?php echo get_the_title();?></strong>
							<a class="user" href="<?php echo get_permalink();?>"><i class="fa fa-user"></i><?php echo get_the_author(); ?></a>
							<a class="calendar" href="<?php echo get_permalink();?>"><i class="fa fa-calendar"></i><?php echo get_the_date();?></a>
						</div>
                    </li>
					<!-- Church Widget Code Popular Post END -->
