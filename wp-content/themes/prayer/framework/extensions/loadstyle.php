...
<<<<<<< HEAD
			...
			if($font_google_heading <> 'Default'){ echo ' .latest-event .view-calender, .btn-purchase, .btn-submit-news, strong.title, .text-area strong.title a, h1, h2, h3, h4, h5, h6{ font-family:"droid_sansregular", Arial, Verdana, Helvetica, sans-serif !important;}'; }else{ echo 'h1, h2, h3, h4, h5, h6{}';}
